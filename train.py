...
def train(model, ewc_regularizer, train_datasets, test_datasets, epochs_per_task=10,
    ...
    for task, train_dataset in enumerate(train_datasets, 1):
        for epoch in range(1, epochs_per_task+1):
            ...
            for batch_index, (x, y) in data_stream:
                ...
                ewc_loss = ewc_regularizer.regularize(model.named_parameters())
        ...
        if consolidate and task < len(train_datasets):
            ...
            ewc_regularizer.update_fisher_optpar(model, task, train_dataset, 
